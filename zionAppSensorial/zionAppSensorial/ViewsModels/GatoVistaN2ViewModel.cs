...
{
    public class GatoVistaN2ViewModel : BindableObject
    {
        ...
        public ICommand GatoButtonClickedCommand { get; }
        ...
        public GatoVistaN2ViewModel()
        {
            IncorrectButtonCommand = new Command<string>(async (button) => await OnIncorrectButtonClicked(button));
            GatoButtonClickedCommand = new Command(async () => await OnGatoButtonClicked());
        ...
        private async Task OnGatoButtonClicked()
        {
        ...
        {
            var text = "Con patas sigilosas y un ronroneo suave, en la noche maúllo, ¿qué soy?";
